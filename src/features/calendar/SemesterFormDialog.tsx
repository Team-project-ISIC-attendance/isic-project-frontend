  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent
        ...
        className="w-[480px] max-w-[calc(100%-2rem)] p-0 gap-0"
      >
        {/* Header */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm font-normal text-[#525252] leading-5">
                Vyplňte všetky potrebné polia a následne môžete vytvoriť nový semester.
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="px-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="semester-name" className="text-sm font-medium text-[#414651]">
                Názov
              </Label>
              <input
                id="semester-name"
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-1 flex-col gap-2">
                <Label htmlFor="semester-start" className="text-sm font-medium text-[#414651]">
                  Začiatok
                </Label>
              ...
              {/* Koniec */}
              <div className="flex flex-1 flex-col gap-2">
                <Label htmlFor="semester-end" className="text-sm font-medium text-[#414651]">
                  Koniec
                </Label>
                <div className="flex items-center rounded-lg border border-[#d5d7da] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]">
                  <input
